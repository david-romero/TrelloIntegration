...
public class CustomTrelloURL {
	...
	//Custom dromera
	public static final String LABEL_URL = "https://api.trello.com/1/labels/{0}";
	public static final String CARD_URL_ADD_LABEL = "https://api.trello.com/1/cards/{0}/idLabels";
	public static final String CARD_URL_ADD_MEMBER = "https://api.trello.com/1/cards/{0}/idMembers";
	public static final String CARD_URL_ADD_COMMENT = "https://api.trello.com/1/cards/{0}/actions/comments";
    ...
    public static CustomTrelloURL create(String apiKey, String url,
			String... pathParams) {
		return new CustomTrelloURL(apiKey, url, pathParams);
	}

	private CustomTrelloURL(String apiKey, String url, String... pathParams) {
		this.apiKey = apiKey;
		this.url = url;
		this.pathParams = pathParams;
	}

	public CustomTrelloURL token(String token) {
		this.token = token;
		return this;
	}

	public CustomTrelloURL filter(String... filters) {
